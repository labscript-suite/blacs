...
#
#     pip install --index-url https://test.pypi.org/simple/ blacs
#
...
setup(
    name='blacs',
    version=run_path(os.path.join('blacs', '__version__.py'))['__version__'],
    description="Main hardware control program from the labscript suite",
